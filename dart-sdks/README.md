...
- `dart_sdks.sui`
  ...
  - `GraphQlClient` powered by official Dart `graphql` package
    - includes helper methods: `discoverRpcApi`, `query`, `mutation`, `getBalance`, `getAllBalances`, `iterAllBalances`, `getCoins`, `getGas`, `iterCoins`, `getOwnedObjects`, `iterOwnedObjects`, `getDynamicFields`, `iterDynamicFields`, `getCoinMetadata`, `getTotalSupply`, `getDefaultSuinsName`, `resolveNameServiceAddress`, `resolveNameServiceNames`, `getObject`, `multiGetObjects`, `getEventsByTransaction`, `queryEvents`, `iterEvents`, `queryTransactionBlocks`, `iterTransactionBlocks`, `getMoveFunction`, `simulateTransaction`, `dryRun`, `resolveTransaction`, `getTransactionBlock`, `executeTransactionBlock`, `getCheckpoint`, `getCheckpoints`, `iterCheckpoints`, `getLatestCheckpointSequenceNumber`, `getCommitteeInfo`, `getStakes`, `getStakesByIds`, `getChainIdentifier`, `getProtocolConfig`, `getReferenceGasPrice`, `getCurrentSystemState`, `getLatestSuiSystemState`
