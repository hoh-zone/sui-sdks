...
class Secp256r1Keypair private constructor(
    private val privateKey: PrivateKey,
    private val publicKey: PublicKey,
) : Keypair {
    companion object {
        fun generate(): Secp256r1Keypair {
            return try {
                BouncyCastleProviderHolder.ensureInstalled()
                val generator = KeyPairGenerator.getInstance("EC", "BC")
                generator.initialize(ECGenParameterSpec("secp256r1"))
                val pair = generator.generateKeyPair()
                Secp256r1Keypair(pair.private, pair.public)
            } catch (e: Exception) {
                throw IllegalStateException("Failed to generate secp256r1 keypair", e)
            }
        }
        ...
        fun verifyWithPublicKey(compressedPublicKey: ByteArray, message: ByteArray, signature: ByteArray): Boolean {
            return try {
                ...
                verifier.initVerify(publicKeyFromCompressed(compressedPublicKey, "secp256r1"))
    ...
    override fun scheme(): SignatureScheme = SignatureScheme.SECP256R1
    ...
    override fun sign(message: ByteArray): ByteArray {
        return try {
            ...
            throw IllegalStateException("Failed to sign with secp256r1", e)
        }
    }
